...
# 预设网易云 Cookie（用户提供的有效 Cookie）
PRESET_NCM_COOKIE = "WYYY=bXr23I%2BjmkHMyPKRuhSbTl%5Cda%5C0qKzvpddHbDlXGvDWBUZ3yQcqcwFYRk%5CkHhhSmt3bDv4Ej8yS3n6vsA2qP9MqOc%2F1lMriEtIuUhlSA8YfckH4VPHktbbW5RQdIa%2F8ipjlgObwzDwR62%2F%2FqspN5z%2FQSIQDBCdg6qbnd1Ma%5CZ6m%5Cp%2FJh%3A1787298053460; _iuqxldmzr_=32; _ntes_nnid=d49ea4052c11597f862c229193cd42ba,1787296253475; _ntes_nuid=d49ea4052c11597f862c229193cd42ba; NMTID=00OozROGi8hT5Hlokipqka-Q-gEIG0AAAGgIyiKtA; WM_NI=Z%2B0CgjX2wjsbrn86B7mvoptw2E2eRph%2BpFcG0UgQk8WbwPAkNB6xDC71FA4RAc1LbibmwI8nUyIGjeXXsCaYiJ8BUjiQqIBlW1A7WtQFn4vuuB7IvtYoyA6KFOY%2BUGYVVjM%3D; WM_NIKE=; WM_TID=%2FywT7kocblpERQFEVVKJVAgaGZCSQ9MV; ntes_utid=tid._.S25EgYYHyBtEU0RQQVOdFExPWYTGU%252FI3._.0; sDeviceId=YD-vuccf5M1QrREQhRQAQKIQFgbDJTTB6Jy; __snaker__id=QH5sUVeWtBGENe3d; gdxidpyhxdE=5PmnuDVuOQBSKRzOnUlMP0P99Zo%2B7HNYlMo4Nr%2B7RoIQLzmVpiZCdWysQijlZR%2B8nU%2FbMTdISKp6DiONqIl5Z9xVMylc8%2FBl9k3woG%5CJ%5CHSqN%2Bgc9tHwzlt6IRWOH%2B6R2S4mMZ%5C5yUoP%5Ct67zyNtI9zHwjAeXChOYJoST9wrSSwjV01b%3A1787297172087; MUSIC_U=; __csrf=079ce26937d94962659c8c01fa396ebf; ntes_kaola_ad=1"
...
╚═══════════════════════════════════════════════╝
""")
    # 优先使用预设的 NCM Cookie，如果没有则使用保存的 Cookie
    cfg = load_config()
    cookie_to_use = PRESET_NCM_COOKIE if PRESET_NCM_COOKIE else cfg["ncm"].get("cookie")
    if cookie_to_use:
        api = NetEaseAPI(cookie=cookie_to_use)
        downloader = Downloader(api)
        print(f"✓ 网易云音乐已登录 (使用{'预设' if PRESET_NCM_COOKIE else '保存的'} Cookie)")
